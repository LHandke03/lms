...
const routes = [
	...
	{
		path: '/courses/:courseName/completion',
		name: 'CoursesCompletion',
		component: () => import('@/pages/CoursesCompletion.vue'),
		props: true,
	},
	{
		path: '/courses/:courseName/learn/:chapterNumber-:lessonNumber/:time_per_lesson',
		name: 'Lesson',
